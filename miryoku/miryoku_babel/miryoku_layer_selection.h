...
#include "miryoku_layer_alternatives.h"
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_HE_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_QWERTY)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_HE
    #elif defined (MIRYOKU_EXTRA_QWERTZ)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GAMING_FLIP
...
#if !defined(MIRYOKU_LAYER_HE_NUM)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #define MIRYOKU_LAYER_HE_NUM MIRYOKU_ALTERNATIVES_HE_NUM_FLIP
  #else
    #define MIRYOKU_LAYER_HE_NUM MIRYOKU_ALTERNATIVES_HE_NUM
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_HE_NUM)
  #define MIRYOKU_LAYERMAPPING_HE_NUM MIRYOKU_MAPPING
#endif
